...
<div class="box-alamat">
	<div class="logo">
		<img src="../favicon-32x32.png"><span>Tumbas | Riwayat</span>
	</div>
	...
	<div class="bayar">
		<table>
			<tr>
				...
				<td><sup>Rp</sup><?= ($row['harga'] * $row['banyak']) . "K"; ?></td>
			</tr>
			...
			<form action="" method="post">
				<td><a href="buy.php"><button type="button" name="sukses">Order Now</button></a></td>
			</form>
			</tr>
